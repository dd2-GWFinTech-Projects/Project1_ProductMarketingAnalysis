...
class TimeSeriesModelUtilities:
    ...
    def convert_df_to_dict(data_df, dict_lookup_list):
        data_dict = {}
...
class TimeSeriesModelPredictionPreviewUtilities:
    ...
    def generate_prediction_preview(self, model_type, values_dict_df, change_values_dict_df):
        ## Convert data types
        values_dict=convert_df_to_dict(values_dict_df, classification_list)
        change_values_dict=convert_df_to_dict(change_values_dict_df, classification_list)
        ## Build, train, predict
        ...
        model_predictions__values_dict__df.columns = classification_list_prediction_names
    ...
    def build_model(self, model_type, values_dict, change_values_dict):
        if model_type == ModelType.LinearRegressionDictModel:
            return LinearRegressionDictModel(
                ...
                x=year_list, dict_lookup_list=classification_list,
